...
function conf_binary_vars() {
    ...
    if ! gpg --list-keys "$__gpg_archypie_key" &>/dev/null; then
        pacman-key --keyserver hkps://keyserver.ubuntu.com:443 --recv-keys 87353250AEC9CF3A876EC3CBBCB4D9FBFEEE2E93 && \
        pacman-key --lsign-key 87353250AEC9CF3A876EC3CBBCB4D9FBFEEE2E93
    fi
