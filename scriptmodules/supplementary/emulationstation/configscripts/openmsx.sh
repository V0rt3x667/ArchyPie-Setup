...
function onend_openmsx_joystick() {
    ...
    mkdir -p "$configdir/openmsx/share/joystick/game"
    cat > "$configdir/openmsx/share/joystick/$conf.tcl" <<_EOF_
...
cat > "$configdir/openmsx/share/joystick/README.txt" <<_EOF2_
