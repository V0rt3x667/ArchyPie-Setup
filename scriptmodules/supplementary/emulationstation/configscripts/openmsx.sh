...
They are read by openMSX at start-up & loaded automatically when the corresponding joypad is plugged in.
 ...
 * edit the file & adjust the 'bind_default' commands or the 'joystick1_config' configuration.
 ...
 * rename the new '.tcl' file so the name is similar to the disk/tape/rom name (i.e. 'Metal Gear.zip' will load 'Metal Gear.tcl').
   If you are not sure which name to use, start the game, then press 'F10' & type 'guess_title', followed by Enter.
